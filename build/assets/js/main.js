...
$('.mission_parallax_big').parallaxBackground();
$('.mission_parallax_small').parallaxBackground();
(function() {
  var MutationObserver, Util, WeakMap, getComputedStyle, getComputedStyleRX,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
$(function() {
    ...
    */
    ...
    var wow = new WOW({
        offset:       77,          // distance to the element when triggering the animation (default is 0)
...
$(function() {
    ...
    var date = new Date(2018, 2, 12); // YYYY, 0-11 - month, 1-31 day
...
$(function () {
    ...
    if (results && results[1]) {
        $.post(appApiHost("/subscribe/confirm/" + results[1], "v2.0"))
            .done(function () {
